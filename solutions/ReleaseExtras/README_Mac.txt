Install Instructions: Copy all the files EXCEPT the osx folder from this zip to the Terraria install folder. Then, copy the libMonoPosixHelper.dylib file from the osx folder to the osx folder in your install directory. Then, you'll need to give execute permissions to the TerraCustom file. To do this, open a terminal in the install directory and run this command:
    chmod +x TerraCustom
