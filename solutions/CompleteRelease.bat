...
:: Windows release
copy ..\src\TerraCustom\bin\WindowsRelease\net45\Terraria.exe "%destinationFolder%\TerraCustom Windows %version%\%exeFile%" /y
...
:: Mac release
copy ..\src\TerraCustom\bin\MacRelease\net45\Terraria.exe "%destinationFolder%\TerraCustom Mac %version%\%exeFile%" /y
...
:: Linux release
copy ..\src\TerraCustom\bin\LinuxRelease\net45\Terraria.exe "%destinationFolder%\TerraCustom Linux %version%\%exeFile%" /y
