...
//            File.WriteAllText(Path.Combine(Program.baseDir, "src/TerraCustom/Terraria.csproj.user"), DebugConfig);
...
//                "TerraCustom.sln /p:Configuration=MacRelease /p:Platform=\"x86\"",
